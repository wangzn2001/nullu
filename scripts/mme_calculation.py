...
"""
python calculation.py --results_dir /path/to/your_results"
"""

parser = argparse.ArgumentParser()
parser.add_argument('--results_dir', default='/path/to/your_results', type=str)
    ...
    def process_result(self, results_dir):
        ...
        for eval_type, task_name_list in eval_type_dict.items():
            ...
            for task_name in task_name_list:
                ...
                # delect the last blank line with an odd index ##########
                # if len(lines) % 2 != 0:
                #     lines = lines[:-1]
